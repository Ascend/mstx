...
典型使用场景请参见《[msOpProf工具 mstx扩展功能](https://gitcode.com/Ascend/msopprof/blob/26.0.0/docs/zh/user_guide/extended_functions.md#mstx扩展功能)》和《[msSanitizer工具 mstx扩展功能](https://gitcode.com/Ascend/mssanitizer/blob/26.0.0/docs/zh/api_reference/mssanitizer_api_reference.md#mstx扩展功能)》。
